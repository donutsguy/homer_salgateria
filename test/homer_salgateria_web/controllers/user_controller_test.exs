defmodule HomerSalgateriaWeb.UserControllerTest do
  use HomerSalgateriaWeb.ConnCase

  import HomerSalgateria.AccountFixtures

  @create_attrs %{cpf: "some cpf", email: "some email", nome: "some nome", senha: "some senha", numero_telefone: "some numero_telefone", data_nascimento: ~D[2024-05-03], funcao: "some funcao"}
